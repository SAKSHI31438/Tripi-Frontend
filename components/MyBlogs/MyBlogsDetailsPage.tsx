  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await axios.delete(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/blog/deleteBlog/${id}`
      );
      console.log(response.data);

      toast.success("Blog Deleted Successfully", { type: "success" });
              ...
              {!isFetching && (
                <div className="space-x-2">
                  <Link
                    ...
                    className="inline-flex items-center px-2 py-2 bg-blue-800 hover:bg-blue-600 text-white rounded-full text-sm"
                  >
              ...
              <div className="mb-4">
                <Breadcrumb>
                  <BreadcrumbList>
                    ...
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                      <BreadcrumbLink href="/myBlogs">My Blogs</BreadcrumbLink>
                    </BreadcrumbItem>
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
